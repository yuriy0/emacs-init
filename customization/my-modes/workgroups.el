...
;; ;; (defun find-file--autosave (do- &rest do-args)
;; ;;   (let* ((ret (apply do- do-args)))
;; ;;     (message "find-file returned %s" ret)
;; ;;     (wg-associate-buffer-with-workgroup nil ret nil)
;; ;;     ret))
;; ;; (advice-add 'find-file :around 'find-file--autosave)
